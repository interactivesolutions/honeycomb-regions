    ...
    public function up()
    {
        Schema::table('hc_regions_countries', function(Blueprint $table) {
            $table->foreign('region_id',
                'fk_hc_regions_countries_hc_regions_continents')->references('id')->on('hc_regions_continents')->onUpdate('NO ACTION')->onDelete('NO ACTION');
            $table->foreign('flag_id',
                'fk_hc_regions_countries_hc_resources1')->references('id')->on('hc_resources')->onUpdate('NO ACTION')->onDelete('NO ACTION');
        });
    }
