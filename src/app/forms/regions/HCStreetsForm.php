...
{
    // name of the form
    protected $formID = 'regions-streets';
    ...
    {
        $form = [
            'storageURL' => route('admin.api.regions.streets'),
            'buttons' => [
                [
                    "class" => "col-centered",
            ...
            'structure' => [
                ...
                [
                    "type" => "dropDownList",
                    "fieldID" => "city_parts",
                    "label" => trans("HCRegions::regions.parts"),
                    "required" => 0,
                    "requiredVisible" => 0,
                    "search" => [
                        "showNodes" => ["name"],
                    ...
                    "dependencies" => [
                        [
                            "field_id" => "city_id",
                            "options_url" => route('admin.api.regions.parts.list'),
                        ],
                    ],
                ],
                [
